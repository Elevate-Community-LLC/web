    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { module: 'services' },
          component: () => import('@/views/services/CustomizationServiceView.vue'),
        },
        {
          path: 'platforms/sales',
          name: 'Sales Platforms',
          meta: { module: 'platforms' },
          component: () => import('@/views/platforms/SalesPlatformView.vue'),
        },
        {
          path: 'platforms/work-management',
          name: 'Work Management Platforms',
          meta: { module: 'platforms' },
          component: () => import('@/views/platforms/WorkManagementPlatformView.vue'),
        },
        {
          path: 'platforms/field-operations',
          name: 'Field Operations Platforms',
          meta: { module: 'platforms' },
          component: () => import('@/views/platforms/FieldOperationsPlatformView.vue'),
        },
        {
          path: 'platforms/finance-accounting',
          name: 'Finance & Accounting Platforms',
          meta: { module: 'platforms' },
          component: () => import('@/views/platforms/FinanceAccountingPlatformView.vue'),
        },
        {
          path: 'products/salesforce',
          name: 'Salesforce',
          meta: { module: 'products' },
          component: () => import('@/views/products/SalesforceProductView.vue'),
        },
        {
          path: 'products/procore',
          name: 'Procore',
          meta: { module: 'products' },
          component: () => import('@/views/products/ProcoreProductView.vue'),
        },
        {
          path: 'products/sage',
          name: 'Sage',
          meta: { module: 'products' },
          component: () => import('@/views/products/SageProductView.vue'),
        },
        {
          path: 'products/workato',
          name: 'Workato',
          meta: { module: 'products' },
          component: () => import('@/views/products/WorkatoProductView.vue'),
        }
      ]
    },
  ],
